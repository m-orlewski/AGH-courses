...
private:
    ...
    void line2d(Matrix t, double x1, double y1, double x2, double y2, wxDC* dc, int w, int h, bool flag=false, bool vertical = false);
...
public:
    ...
    Matrix rotationMatrix(int w, int h) const;
    Matrix scaleMatrix(int w, int h) const;
};
