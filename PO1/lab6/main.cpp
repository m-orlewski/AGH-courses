...
* DNA (dna.h) - klasa pochodna klasy RNA implementująca łańcuch DNA. Łańcuch DNA jest ciągiem dwóch łańcuchów RNA, połączonych słabymi wiązaniami - proszę wykorzystać dziedziczenie pól.
  Klasa ma być minimalistyczna, całość może być napisana w dna.h - wystarczy się w niej ograniczyć do konstruktora i funkcji wyświetlającej.
